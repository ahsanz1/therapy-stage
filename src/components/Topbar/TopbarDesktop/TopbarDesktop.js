...
const TopbarDesktop = props => {
  ...
  const loginLink = isAuthenticatedOrJustHydrated ? null : (
    <NamedLink params={{ is_login: 'true' }} name="LoginPage" className={css.loginLink}>
  ...
  return (
    <nav className={classes}>
      ...
      <div>
        <NamedLink className={css.createListingLink} name="HomePage">
          <span className={css.createListing}>
        ...
        <NamedLink className={css.createListingLink} name="FreeConsultation">
          <span className={css.createListing}>
