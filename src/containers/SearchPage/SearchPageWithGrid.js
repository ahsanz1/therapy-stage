...
export class SearchPageComponent extends Component {
  ...
  render() {
    ...
    const therapyTypeFilters = availableFilters.filter(type => type.key === 'FiltersID');
    const skipTherapyTypeFilters = availableFilters.filter(type => type.key !== 'FiltersID');
        ...
        <div className={css.layoutWrapperContainer}>
          <aside className={css.layoutWrapperFilterColumn} data-testid="filterColumnAside">
            <div className={css.filterColumnContent}>
              {skipTherapyTypeFilters.map(config => {
                return (
                  <FilterComponent
              ...
              >
                ...
                {listingsAreLoaded ? (
                  <SearchResultsPanel
                    ...
                    isMapVariant={false}
                    therapyTypeFilters={therapyTypeFilters}
                    onManageDisableScrolling={onManageDisableScrolling}
                    marketplaceCurrency={marketplaceCurrency}
                    urlQueryParams={urlQueryParams}
                    intl={intl}
