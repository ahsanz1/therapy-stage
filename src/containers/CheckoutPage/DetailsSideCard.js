  ...
  return (
    <div className={css.detailsContainerDesktop}>
      ...
      <div className={css.listingDetailsWrapper}>
        ...
        <div className={css.detailsHeadings}>
          <H4 as="h2">
            <NamedLink
              name="ListingPage"
              params={{ id: listing?.id?.uuid, slug: createSlug(listingTitle), organizedName: organizedName}}
            >
              {listingTitle}
            </NamedLink>
          </H4>
          ...
          <div className={css.priceContainer}>
            ...
            <div className={css.perUnit}>
              <FormattedMessage id="CheckoutPageWithInquiryProcess.perUnit" values={{ unitType }} />
            </div>
          </div>
          {/* ) : null} */}
        </div>
      ...
      <OrderBreakdown
        ...
        bookingData={orderData.allLineItem}
      />
    </div>
  );
};
