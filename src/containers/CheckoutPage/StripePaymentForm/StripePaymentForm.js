...
import TermsModal from '../../../components/policy-modals';
...
const LocationOrShippingDetails = props => {
  ...
  ) : isBooking && !isFuzzyLocation ? null : null; // </div> //   <p className={css.locationDetails}>{locationDetails}</p> //   </Heading> //     <FormattedMessage id="StripePaymentForm.locationDetailsTitle" /> //   <Heading as="h3" rootClassName={css.heading}> // <div className={css.locationWrapper}>
};
...
class StripePaymentForm extends Component {
  ...
  paymentForm(formRenderProps) {
    ...
    const { cardValueValid, paymentMethod, isModal } = this.state;
    ...
    const [isCheckboxCheck, setIsCheckboxCheck] = useState({
      ...
      >
        ...
        <div className={css.submitContainer}>
          ...
          <FieldCheckboxComponent
            ...
            checked={isCheckboxCheck?.termsCondition}
            onChange={e => {
              setCurrentCheckbox(e.target.value);
              if (!e.target.checked) {
                setIsCheckboxCheck({
                  ...isCheckboxCheck,
                  termsCondition: false,
          ...
          <FieldCheckboxComponent
            ...
            value={'termsServices'}
            checked={isCheckboxCheck?.termsServices}
            onChange={e => {
              setCurrentCheckbox(e.target.value);
              if (!e.target.checked) {
                setIsCheckboxCheck({
          ...
          <PrimaryButton
            ...
            inProgress={submitInProgress}
            disabled={
              !isCheckboxCheck?.termsCondition || !isCheckboxCheck?.termsServices || submitDisabled
            }
          >
        ...
        <TermsModal
          ...
          css={css}
          setIsCheckboxCheck={setIsCheckboxCheck}
...
StripePaymentForm.propTypes = {
  ...
  onManageDisableScrolling: string.isRequired,
